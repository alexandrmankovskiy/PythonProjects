...
while True:
	...
	if (int(filterpar[0]) > 7 and int(filterpar[0]) < 65) and ((filterpar[1] == 'y' or filterpar[1] == 'n') and (filterpar[2] == 'y' or filterpar[2] == 'n') and (filterpar[3] == 'y' or filterpar[3] == 'n')):
		print('')
		filters(int(filterpar[0]), filterpar[1], filterpar[2], filterpar[3])
		again = input('Do you want to generate more? Press Enter to continue or type "n" to leave: ')
		if again == 'n':
			break
		else:
			continue
